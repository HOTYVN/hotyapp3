...
class Catmenu_Filter extends StatefulWidget {
  ...
  @override
  _Catmenu_Filter createState() => _Catmenu_Filter();
}


class _Catmenu_Filter extends State<Catmenu_Filter> {
  // 생활정보 카테고리
...
/*    coderesult.forEach((element) {
  ...
  void initState() {
    super.initState();
    check_sub_catlist.addAll(widget.getcheck_sublist);
    print(check_sub_catlist);
    check_detail_catlist.addAll(widget.getcheck_detiallist);
    print(check_detail_catlist);
    check_detail_arealist.addAll(widget.getcheck_areadetiallist);
    print(check_detail_arealist);
    setcode().then((_) {
      setState(() {
      });
    });
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: IconButton(icon: Icon(Icons.close_rounded),color: Colors.black,alignment: Alignment.centerRight,iconSize: 24 * (MediaQuery.of(context).size.width / 360),
              onPressed: (){
              ...
              child: ElevatedButton(
                ...
                onPressed: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context) {
                      return LivingList(title_catcode: main_title_catcode, check_sub_catlist: check_sub_catlist, check_detail_catlist: check_detail_catlist, check_detail_arealist: check_detail_arealist,);
                    },
                  ));
                },

...
class ProfileApartmentWrite extends StatefulWidget{
  const ProfileApartmentWrite({super.key});

  @override
  State<ProfileApartmentWrite> createState() => _ProfileApartmentWriteState();
}

class _ProfileApartmentWriteState extends State<ProfileApartmentWrite> {
        ...
        child : Scaffold(
          appBar: AppBar(
            ...
            title: Container(
              ...
              child: Text("나의 아파트 관리" , style: TextStyle(fontSize:  16 * (MediaQuery.of(context).size.width / 360),  color: Color(0xff0F1316), fontWeight: FontWeight.w600,),
              ),
            ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child:  Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text('저장하기', style: TextStyle(fontSize: 20, color: click_check == 0 ? Color(0xffE47421) : Colors.white, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                          ],
                        ),
                      ),
                    )
  ...
  void FlutterDialog(context) async {
    ...
    var url = Uri.parse(
      'http://www.hoty.company/mf/member/addMemberApartment.do',
      //'http://192.168.100.31:8080/mf/member/addMemberApartment.do',
    );
    String? msg;
    if(_name.text == ""){
      msg = "아파트 별칭은 필수 항목입니다.";
    }
    Map jsoData = {
      "memberId": reg_id,
      "name": _name.text,

...
class ProfilemyPostFilter extends StatefulWidget {
  final List<String> getcheck_detail_catlist;
  final List<dynamic> catlist;
  const ProfilemyPostFilter({Key? key,
    required this.getcheck_detail_catlist,
    required this.catlist,
  }) : super(key:key);
  @override
  _ProfilemyPostFilter createState() => _ProfilemyPostFilter();
}



class _ProfilemyPostFilter extends State<ProfilemyPostFilter>{

  //보여줄 필터 리스트
  List<String> viewcode = ['C1','D2','E1'];
  List<String> viewtitlecode = ['Living Information','KIN'];
  ...
  List<String> check_detail_table_nm = []; //선택된 테이블nm
  ...
  Widget build(BuildContext context) {
    ...
    /*                  if(check_sub_catlist.length > 0) {
                      ...
                      return Profile_my_post(table_nm: '', category: title_catcode);
                    },
                  ));
                },
                    ...
                    Container(
                      ...
                      child: Wrap(
                        ...
                        /*  Container(
                          ...
                          for(int m2=0; m2<widget.catlist.length; m2++)
                              Container(
                                width: 175 * (MediaQuery.of(context).size.width / 360),
                                height: 15 * (MediaQuery.of(context).size.height / 360),
                                child: Row(
                                    ...
                                    Container(
                                      child: Transform.scale(
                                        ...
                                        child: Checkbox(
                                          ...
                                          value: check_sub_catlist.contains(widget.catlist[m2]['idx']),
                                          // value: true,
                                          activeColor: Color(0xffE47421),
                                          checkColor: Colors.white,
                                          onChanged: (val) {
                                            ...
                                            _onSubSelected(val!, widget.catlist[m2]['idx']);
                                          },
                                        ),
                                      ),
                                    ),

...
import '../../community/dailytalk/community_dailyTalk_write.dart';
import '../../login/login.dart';
import '../../main/main_page.dart';

class M_CommunityDailyTalk extends StatefulWidget {
  final String main_catcode;
  final String serchtext;

  const M_CommunityDailyTalk({super.key, required this.main_catcode, required this.serchtext});
...
class _CommunityDailyTalk extends State<M_CommunityDailyTalk> {
  Map params = {};

...
class M_KinList extends StatefulWidget {
  final bool success;
  final bool failed;
  final dynamic main_catcode;
  final String serchtext;

  const M_KinList({Key? key,
    required this.success,
    required this.failed,
    required this.main_catcode, required this.serchtext,
  }) : super(key:key);

  @override
  State<M_KinList> createState() => _KinListState();
}
...
class _KinListState extends State<M_KinList> {
  ...
  void initState() {
    ...
    _searchController.text = widget.serchtext;
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          if(result[i]["list"]["comment_conts"] != null && result[i]["list"]["comment_conts"] != '')
                          Container(
                              width: 360 * (MediaQuery.of(context).size.width / 360),

        ...
        children: [
          Container(
            child: Column(
              children: [
                Container(
                  width: 580 * (MediaQuery.of(context).size.width / 360),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('호치민 관련 질문하고 답변하기', style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Image(image: AssetImage('assets/intro_page3.png')),
                      )
                    ],
                  ),
                ),

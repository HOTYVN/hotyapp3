...
class KinAdoptModify extends StatefulWidget {
  final int article_seq;
  final int comment_seq;
  final dynamic table_nm;
  final dynamic state;

  const KinAdoptModify({Key? key,
  ...
  @override
  State<KinAdoptModify> createState() => _KinAdoptModifyState();
}

class _KinAdoptModifyState extends State<KinAdoptModify> {

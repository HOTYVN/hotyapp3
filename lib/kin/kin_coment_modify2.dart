...
class KinCommentModify2 extends StatefulWidget {
  final int article_seq;
  final int comment_seq;
  final dynamic table_nm;

  const KinCommentModify2({Key? key,
  ...
  @override
  State<KinCommentModify2> createState() => _KinCommentModify2State();
}

class _KinCommentModify2State extends State<KinCommentModify2> {
  ...
  Future<void> FlutterDialog(context) async {
      ...
      if (res["result"] != null && res["resultstatus"] == "N") {
        Navigator.push(context, MaterialPageRoute(
          builder: (context) {
            return KinView2(article_seq: widget.article_seq, table_nm: "KIN", main_catcode: "B06", params: {});
          },
        ));
      }
    }

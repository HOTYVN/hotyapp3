...
class Reportwrite extends StatefulWidget {
  ...
  @override
  _Reportwrite createState() => _Reportwrite();
}

class _Reportwrite extends State<Reportwrite> {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding : EdgeInsets.fromLTRB(15 * (MediaQuery.of(context).size.width / 360), 8 * (MediaQuery.of(context).size.height / 360), 0, 0),

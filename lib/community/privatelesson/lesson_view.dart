...
import 'package:hoty/community/privatelesson/lesson_modify.dart';
import 'package:hoty/community/privatelesson/lesson_review_write.dart';
...
import '../../kin/kin_coment_modify.dart';
...
class _LessonView extends State<LessonView> {
  ...
  var url2 = "type=view@@table_nm=PERSONAL_LESSON@@article_seq=";
  ...
  Future<dynamic> getviewdata() async {
    ...
    var url = Uri.parse(
      ...
      // 'http://192.168.0.109/mf/community/view.do',
    );
    ...
    try {
      ...
      if(response.statusCode == 200) {
        ...
        for(int i=0; i<coderesult.length; i++){
          if(coderesult[i]['pidx'] == widget.table_nm){
  ...
  Future<dynamic> getpnlistdata() async {
    ...
    try {
      Map data = {
        ...
        "main_checklist" : checklist.toList(),
        "cat02" : 'E202',
        "board_seq": board_seq.toString(),
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child : Container(
                                          padding : EdgeInsets.fromLTRB(8 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360),
                                              8 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                          child : Image(image: AssetImage("assets/add_a_gallary.png"), color:Color(0xffC4CCD0), width : 22 * (MediaQuery.of(context).size.width / 360))
                                        )
                                      ),
                                      GestureDetector(
                                          onTap : () {
                                          ...
                                          child : Container(
                                            padding : EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360),
                                                8 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                            child : Image(image: AssetImage("assets/add_a_photo.png"), color:Color(0xffC4CCD0), width : 24 * (MediaQuery.of(context).size.width / 360))
                                          )
                                      ),
                                      GestureDetector(
                                        onTap : () {
                                        ...
                                        child : Container(
                                            ...
                                            child : Text("취소", style: TextStyle(color : Color(0xffE47421), fontSize: 16 * (MediaQuery.of(context).size.width / 360), fontWeight: FontWeight.w800),)
                                        ),
                                      ),
                                      GestureDetector(
                                        onTap : () {
                                        ...
                                        child : Container(
                                            ...
                                            child : Text("저장", style: TextStyle(color: Color(0xffFFFFFF), fontSize: 16 * (MediaQuery.of(context).size.width / 360), fontWeight: FontWeight.w800,),)
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                GestureDetector(
                                  onTap:() {
                                    ...
                                    Navigator.push(context, MaterialPageRoute(
                                      // fullscreenDialog: true,
                                      builder: (context) {
                                        return LessonView(article_seq: pnlist[i]['article_seq'], table_nm: pnlist[i]['table_nm'], params: widget.params,checkList: widget.checkList,);
                                      },
                                    ));
                                  },
                                  child: Container(
        ...
        children: [
          // if(viewresult['main_img_path'] != null && viewresult['main_img'] != null)
            Container(
              ...
              child: ViewInfo_Photo_User(mainfile: '${viewresult['main_img']}', fileresult: fileresult, table_nm: widget.table_nm, code_nm: getSubcodename(viewresult['main_category']),apptitle : '${viewresult['title']}'),
            ),
       /*   Container(
                                ...
                                child:Row(
                                  children: [
                                    for(int m2=0; m2<catname.length; m2++)
                                      if(catname[m2]['idx'] == viewresult['main_category'])
                                        Container(
          ...
          Container(
            ...
            child: Column(
              children: [
                Container(
                  margin : EdgeInsets.fromLTRB(1  * (MediaQuery.of(context).size.width / 360), 1  * (MediaQuery.of(context).size.height / 360),
                        ...
                        child : Row(
                          children: [
                            Container(
                              ...
                              //color: Colors.cyan,
                              child: Text("${viewresult['reg_nm']}", style: TextStyle(fontSize:15, color: Color(0xff2F67D3)),),
                            ),
                            Container(
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(My_icons.rate,
                                    color: viewresult['group_seq'] == '4' ? Color(0xff27AE60) :
                                    viewresult['group_seq'] == '5' ? Color(0xff27AE60) :
                                    viewresult['group_seq'] == '6' ? Color(0xffFBCD58) :
                                    viewresult['group_seq'] == '7' ? Color(0xffE47421) :
                                    viewresult['group_seq'] == '10' ? Color(0xffE47421)
                                        : Color(0xff27AE60),
                                    size: 8 * (MediaQuery.of(context).size.height / 360),),
                                  // Image(image: AssetImage('assets/rate01.png') , width: 16 * (MediaQuery.of(context).size.width / 360) ,),
                                  Text(
                                    "${viewresult['group_nm']}",
                                    style: TextStyle(
                                      fontSize: 12 * (MediaQuery.of(context).size.width / 360),
                      ...
                      Container(
                        ...
                        child: PopupMenuButton(
                          ...
                          itemBuilder : (BuildContext context) => [
                            ...
                            if((reg_id == viewresult["reg_id"] && viewresult['main_category'] != 'E202' )|| adminChk == "Y")
                              PopupMenuItem(value : 'Edit',
                                child: GestureDetector(
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(
                                        builder: (context) {
                                          return LessonModify(article_seq : widget.article_seq, table_nm : widget.table_nm, article_title : viewresult["title"]);
                                        },
                                      ));
                                    },
                                    child: Text(
                ...
                Container(
                  margin : EdgeInsets.fromLTRB(0, 3  * (MediaQuery.of(context).size.height / 360), 0, 5 * (MediaQuery.of(context).size.height / 360)),
                  width: 340 * (MediaQuery.of(context).size.width / 360),
                ...
                Container(
                  margin : EdgeInsets.fromLTRB( 0  * (MediaQuery.of(context).size.width / 360), 0, 0, 5  * (MediaQuery.of(context).size.height / 360)),
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      margin : EdgeInsets.fromLTRB(3 * (MediaQuery.of(context).size.width / 360),0,7 * (MediaQuery.of(context).size.width / 360), 0),
                                      child: Text(
                                        viewresult['like_cnt'].toString(),
                                        style: TextStyle(
                            ...
                            Container(
                              margin : EdgeInsets.fromLTRB(7 * (MediaQuery.of(context).size.width / 360),0, 0, 0),
                              child: Row(
                                children: [
              ...
              children: [
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      launch("tel://${viewresult["etc02"]}");
                    },
                    child:  Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Image(image: AssetImage("assets/phone_icon.png")),
                        Text(' 연락하기', style: TextStyle(fontSize: 20, color: Colors.white),textAlign: TextAlign.center,),
                      ],
                    ),
                  ),
                )
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("리뷰", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'NanumSquareEB',),),
                      ),
                      TextButton(
                          ...
                          onPressed: (){
                            if(reg_id != null && reg_id != "") {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) {
                                  return LessonReviewWrite(filelist: fileresult,
                                      title: viewresult['title'],
                                      rating_cnt: viewresult['rating_cnt'] ?? 0,
                                      comment_cnt: viewresult['comment_cnt'] ?? 0,
                                      like_cnt: viewresult['like_cnt'],
                                      view_cnt: viewresult['view_cnt'],
                                      table_nm: widget.table_nm,
                                      article_seq: widget.article_seq);
                                },
                              ));
                            ...
                            children: [
                              ...
                              Container(
                                margin : EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 1 * (MediaQuery.of(context).size.height / 360),
                                    0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                child: Text(" 리뷰쓰기", style: TextStyle(fontSize: 16 * (MediaQuery.of(context).size.width / 360), color: Color(0xff0F1316), fontFamily: 'NanumSquareB'),),
                              )
                            ],
                          )
                      ),

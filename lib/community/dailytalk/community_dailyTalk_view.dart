...
import 'community_review_write.dart';

class CommunityDailyTalkView extends StatefulWidget {
  ...
  const CommunityDailyTalkView({Key? key,
  ...
  @override
  State<CommunityDailyTalkView> createState() => _CommunityDailyTalkViewState();
}

class _CommunityDailyTalkViewState extends State<CommunityDailyTalkView> {
  ...
  Future<dynamic> getviewdata() async {
    ...
    try {
      ...
      if(response.statusCode == 200) {
        ...
        if(result['like_yn'] != null) {
          var like_cnt = result['like_yn'];
          print(like_cnt);
          if(like_cnt > 0) {
            isLiked = true;
          }
...
// GlobalKey를 저장할 리스트 선언
  ...
  void _generateFormKeys(dynamic list) {
    for (int i = 0; i < list.length; i++) {
      _formKeys["key_${commentlist[i]["list"]["comment_seq"]}"] = GlobalKey<FormState>();
    }
  }
                    ...
                    GestureDetector(
                      onTap: () {
                        getUrl().then((_) {
                          ...
                          _onShare(context, result["title"], shorturl);
                        });
                      },
            ...
            SingleChildScrollView(
              child: Column(
                children: [
                                ...
                                if(reg_id != null && reg_id != "" && reg_id == result["reg_id"])
                                  PopupMenuItem(value : 'delete',
                                    child: GestureDetector(
                                        ...
                                        child: Text(
                                          "삭제하기", style: TextStyle(color: Color(0xffEB5757), fontWeight: FontWeight.w400, fontSize: 16),
                                        )
                                    ),

                                  ),
                                if(reg_id != null && reg_id != "" && reg_id == result["reg_id"])
                                  PopupMenuItem(value : 'modify',
                                    child: GestureDetector(
                                        onTap: () {
                                          Navigator.push(context, MaterialPageRoute(
                                            builder: (context) {
                                              return CommunityDailyTalkModify(article_seq: widget.article_seq, table_nm : widget.table_nm);
                                            },
                                          ));
                                        },
                                        child: Text(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("${getSubcodename(result["main_category"])}", style: TextStyle(color: Color.fromRGBO(196, 204, 208, 1), fontSize: 6 * (MediaQuery.of(context).size.height / 360))),
                          Container(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          margin : EdgeInsets.fromLTRB(5 * (MediaQuery.of(context).size.width / 360), 10 * (MediaQuery.of(context).size.height / 360),
                              0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                          child : Image(
                            image: CachedNetworkImageProvider('http://www.hoty.company/upload/DAILY_TALK/${filelist[f]["yyyy"]}/${filelist[f]['mm']}/${filelist[f]['uuid']}'), fit: BoxFit.scaleDown,
                          ),
                        ),
                      ),
                          ...
                          /*TextButton(
                              ...
                              onPressed: (){
                                if(reg_id != null && reg_id != "") {
                                  Navigator.push(context, MaterialPageRoute(
                                    builder: (context) {
                                      return CommunityReviewWrite(filelist: filelist,
                                          title: result['title'],
                                          rating_cnt: result['rating_cnt'] ?? 0,
                                          comment_cnt: result['comment_cnt'] ?? 0,
                              ...
                              child : Row(
                                children: [
                                  Icon(Icons.star, size: 10 * (MediaQuery.of(context).size.height / 360), color: Color(0xffE47421),),
                                  Container(
                                    margin : EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 1 * (MediaQuery.of(context).size.height / 360),
                                        0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                    child: Text(" 댓글쓰기", style: TextStyle(fontSize: 16 * (MediaQuery.of(context).size.width / 360), color: Color(0xff0F1316), fontFamily: 'NanumSquareB'),),
                                  )
                                ],
                              )
                          ),*/
                  ...
                  /*if(result.length > 0 && commentlist.length == 0)
                    Container(
                        width: 360 * (MediaQuery.of(context).size.width / 360),
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            width: 1, color: Color(0xffF3F6F8),
                          ),
                        ),
                        child : Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child:IconButton(
                                      ...
                                      onPressed: _pickImg,
                                      icon: const Icon(Icons.add_photo_alternate, color: Color(0xffC4CCD0)),
                                    ),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      constraints: BoxConstraints(),
                                      onPressed: null,
                                      icon: const Icon(Icons.emoji_emotions, color: Color(0xffC4CCD0)),
                                    ),
                                  ),
                                  TextButton(
                                    child : Container(
                                        ...
                                        child : Text("저장", textAlign: TextAlign.center, style: TextStyle(color : Color(0xffFFFFFF), fontWeight: FontWeight.w600, fontSize: 18),)
                                    ),
                                    onPressed: () {
                                      if(reg_id != null && reg_id != "") {
                                        commentwriteDialog(context);
                                      }
                                      if(reg_id == null || reg_id == "") {
                                        showModal(context, 'loginalert', '');
                                      }
                          ...
                          child : Column(
                            children: [
                                          ...
                                          children: [
                                            Container(
                                              margin : EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360),
                                                  6 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                              //color: Colors.cyan,
                                              child: Text("${commentlist[i]["list"]["reg_nm"]}", style: TextStyle(fontSize:12 , color: Color(0xff2F67D3)),),
                                            ),
                                            Container(
                                            ...
                                            Container(
                                              ...
                                              child: Row(
                                                children: [
                                                  Image(image: AssetImage('assets/rate01.png') , width: 14 * (MediaQuery.of(context).size.width / 360) ,),
                                                  Text(
                                          ...
                                          child: PopupMenuButton(
                                            ...
                                            itemBuilder : (BuildContext context) => [
                                              ...
                                              PopupMenuItem(value : 'Edit',
                                                child: Text("수정하기", style: TextStyle(color: Color(0xff151515), fontWeight: FontWeight.w400, fontSize: 16),),
                                              ),
                                            ],
                                            onSelected: (String? value) => setState(() {
                                              if(value == 'Edit') {
                                                setState(() {
                                                  ...
                                                  _initComnmentcontroller.text = commentlist[i]["list"]["conts"];
                                                });
                                              }
                                              if(value == "delete") {
                                                setState(() {
                                                  commentdeleteDialog(context,
                                                      commentlist[i]["list"]["comment_seq"]);
                                                });
                                              }
                                            }),
                                            //onSelected: ,`
                              ...
                              if(commentlist[i]["files"].length > 0)
                                Visibility(
                                  visible : commentlist[i]["list"]["visible1"],
                                  child : Container(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image: NetworkImage("http://www.hoty.company/upload/DAILY_TALK/${commentlist[i]["files"][f]["yyyy"]}/${commentlist[i]["files"][f]["mm"]}/${commentlist[i]["files"][f]["uuid"]}"),
                                                        // image: NetworkImage(''),
                                                        fit: BoxFit.contain
                                                    ),
                                                    borderRadius: BorderRadius.circular(3 * (MediaQuery.of(context).size.height / 360)),
                                    ...
                                    child: Column(
                                      children: [
                                        TextField(
                                          minLines: 1,
                                          maxLines: 20,
                                          controller: _initComnmentcontroller,
                                          decoration: InputDecoration(
                                              ...
                                              children: [
                                                ...
                                                TextButton(
                                                  child : Container(
                                                      ...
                                                      alignment: Alignment.center,
                                                      child : Text("취소", textAlign: TextAlign.center, style: TextStyle(color : Color(0xffE47421), fontWeight: FontWeight.w600, fontSize: 18),)
                                                  ),
                                                  onPressed: () => setState(() {
                                                    commentlist[i]["list"]["visible1"] = true;
                                                ...
                                                TextButton(
                                                  ...
                                                  onPressed: () => commentmodifyDialog(context, commentlist[i]["list"]["comment_seq"]),
                                                ),
                                              ],
                                            )
                                        ),
                              ...
                              if(commentlist.length - 1 != i)
                                Container(
                                  ...
                                  child : Divider(thickness: 6, height: 6 * (MediaQuery.of(context).size.height / 360), color: Color(0xffF3F6F8)),
                                ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text("${commentlist[i]["list"]["reg_nm"]} ", style: TextStyle(color: Color(0xff2F67D3), fontSize : 12 * (MediaQuery.of(context).size.width / 360), fontWeight: FontWeight.w700),),
                                                    Icon(My_icons.rate,
                                                        ...
                                                        if(reg_id == commentlist[i]["list"]["reg_id"] || adminChk == "Y")
                                                          PopupMenuItem(value : 'delete',
                                                            child : GestureDetector(
                                                              onTap : () async {
                                                                Navigator.pop(context);
                                                                deletecomment(commentlist[i]["list"]["comment_seq"]);
                                                              },
                                                              child: Text("삭제하기", style: TextStyle(color: Color(0xffEB5757), fontWeight: FontWeight.w400, fontSize: 16),),
                                                            ),
                                                          ),
                                                          ...
                                                          PopupMenuItem(value : 'Edit',
                                                            child: GestureDetector(
                                                                onTap: () {
                                                                  ...
                                                                  Navigator.push(context, MaterialPageRoute(
                                                                    builder: (context) {
                                                                      return CommentModify(article_seq : widget.article_seq, table_nm : widget.table_nm,comment_seq: commentlist[i]["list"]["comment_seq"],main_catcode: widget.main_catcode,);
                                                                    },
                                                                  ));
                                                                },
                                                                child: Text(
                                                            ...
                                                            onTap : () {
                                                              setState(() {
                                                                if(commentlist[i]["list"]["write"] == false) {
                                                                  if(_recommentController.text != null && _recommentController != '') {
                                                                    FlutterDialog2(context, '', commentlist[i]["list"]["comment_seq"], commentlist[i]["list"]["comment_seq"], i);
                                                                  } else {
                                                                    showDialog(context: context,
                                                                        barrierColor: Color(0xffE47421).withOpacity(0.4),
                                                                        builder: (BuildContext context) {
                                        ...
                                        child : Column(
                                          children: <Widget> [
                                                            ...
                                                            if(reg_id == commentlist[j]["list"]["reg_id"] || adminChk == "Y")
                                                              PopupMenuItem(value : 'delete',
                                                                child : GestureDetector(
                                                                  onTap : () async {
                                                                    Navigator.pop(context);
                                                                    deletecomment(commentlist[j]["list"]["comment_seq"]);
                                                                  },
                                                                  child: Text("삭제하기", style: TextStyle(color: Color(0xffEB5757), fontWeight: FontWeight.w400, fontSize: 16),),
                                                                ),
                                                              ),
                                                              ...
                                                              PopupMenuItem(value : 'Edit',
                                                                child: GestureDetector(
                                                                    onTap: () {
                                                                      ...
                                                                      Navigator.push(context, MaterialPageRoute(
                                                                        builder: (context) {
                                                                          return CommentModify(article_seq : widget.article_seq, table_nm : widget.table_nm,comment_seq: commentlist[j]["list"]["comment_seq"],main_catcode: widget.main_catcode,);
                                                                        },
                                                                      ));
                                                                    },
                                                                    child: Text(
                                            ...
                                            Visibility(
                                              ...
                                              child: Container(
                                                  width : 300 * (MediaQuery.of(context).size.width / 360),
                                                  height : commentlist[j]["list"]["_pickedImgs"].length <= 0 ? 62 * (MediaQuery.of(context).size.height / 360) : 92 * (MediaQuery.of(context).size.height / 360) ,
                                                  margin : EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 5 * (MediaQuery.of(context).size.height / 360),
                                                      0 * (MediaQuery.of(context).size.width / 360), 0 * (MediaQuery.of(context).size.height / 360)),
                                                  decoration: BoxDecoration(
                                                    border: Border.all(
                                                                  ...
                                                                  setState(() {
                                                                    if(commentlist[j]["list"]["write"] == false) {
                                                                      if(_recommentController.text != null && _recommentController.text != '') {
                                                                        FlutterDialog2(context, '', commentlist[j]["list"]["parent_seq"] ?? commentlist[j]["list"]["comment_seq"], commentlist[j]["list"]["comment_seq"], j);
                                                                      } else {
                                                                        showDialog(context: context,
                                                                            barrierColor: Color(0xffE47421).withOpacity(0.4),
                                                                            builder: (BuildContext context) {
                                ...
                                GestureDetector(
                                  onTap:() {
                                    ...
                                    Navigator.push(context, MaterialPageRoute(
                                      // fullscreenDialog: true,
                                      builder: (context) {
                                        return CommunityDailyTalkView(article_seq: pnlist[i]['article_seq'], table_nm: pnlist[i]['table_nm'], params: widget.params, main_catcode: widget.main_catcode,);
                                      },
                                    ));
                                  },
                                  child: Container(
                              ...
                              Navigator.pushReplacement(context, MaterialPageRoute(
                                builder: (context) {
                                  return MaterialApp(
                                    ...
                                    home: CommunityDailyTalk(main_catcode: widget.main_catcode),
                                  );

...
import '../privatelesson/model/privatelessonVO.dart';
import 'community_dailyTalk_view.dart';

class CommunityReviewWrite extends StatefulWidget {
  ...
  const CommunityReviewWrite({Key? key,
  ...
  @override
  State<CommunityReviewWrite> createState() => _LessonReviewwrite();
}

class _LessonReviewwrite extends State<CommunityReviewWrite> {
                            ...
                            child: Row(
                              children: [
                               ...
                               /* Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(0 * (MediaQuery.of(context).size.width / 360), 5 * (MediaQuery.of(context).size.height / 360), 0, 0),
                                  child: Row(
                                    children: [
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          ...
          Navigator.push(context, MaterialPageRoute(
            builder: (context) {
              // return LessonView(article_seq: widget.article_seq, table_nm: widget.table_nm);
              return CommunityDailyTalkView(article_seq : widget.article_seq, table_nm : widget.table_nm, main_catcode : widget.main_catcode, params: {},);
            },
          ));
    });
  }

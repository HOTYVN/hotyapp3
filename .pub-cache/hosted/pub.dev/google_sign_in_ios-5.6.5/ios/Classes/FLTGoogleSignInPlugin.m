...
// The key within `GoogleService-Info.plist_20240611` used to hold the application's
...
// The contents of GoogleService-Info.plist_20240611, if it exists.
...
- (void)signInWithCompletion:(nonnull void (^)(FSIUserData *_Nullable,
  ...
  @try {
    ...
    // Otherwise, use settings from the GoogleService-Info.plist_20240611 if available.
...
/// @return @c nil if GoogleService-Info.plist_20240611 not found and clientId is not provided.
